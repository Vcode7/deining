...
const Contact = () => {
  return (
    <section id='contact' class="text-gray-400 bg-transparent body-font relative">
         <div class="flex flex-col text-center w-full">
                <h1 class="sm:text-4xl text-3xl font-medium title-font mt-10 text-white">Contact us</h1>
            </div>
